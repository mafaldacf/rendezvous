#ifndef SERVER_SERVICE_INTERCEPTOR_H
#define SERVER_SERVICE_INTERCEPTOR_H
...
class ServerServiceInterceptor : public grpc::experimental::Interceptor {
    private:
        grpc::experimental::ServerRpcInfo* _info;
    ...
    public:
        explicit ServerServiceInterceptor(grpc::experimental::ServerRpcInfo* info) {
            _info = info;
        }
        ...
        void Intercept(grpc::experimental::InterceptorBatchMethods* methods) override {
            ...
            std::cout << "[SERVER] START " << method << ": " << hook_point << std::endl;
            methods->Proceed();
            std::cout << "[SERVER] END " << method << ": " << hook_point << std::endl;
        }
...
class ServerServiceInterceptorFactory : public grpc::experimental::ServerInterceptorFactoryInterface {
 public:
  grpc::experimental::Interceptor* CreateServerInterceptor(grpc::experimental::ServerRpcInfo* info) override {
    return new ServerServiceInterceptor(info);
  }
};
